...
namespace org.owasp.validator.html.test
{
    ...
    public class AntiSamyTest
    {
        ...
        Policy policy = null;
        string filename = @"properties/antisamy-slashdot.xml";
        ...
        {
            Console.WriteLine("start testScriptAttacks");
            try
            {
        ...
        public void testImgAttacks()
        {
            try
            {
                ...
                //Antisamy.net currently will remove the tag entirely 
                ...
                Assert.IsTrue(antisamy.scan("<IMG SRC=&#0000106&#0000097&#0000118&#0000097&#0000115&#0000099&#0000114&#0000105&#0000112&#0000116&#0000058&#0000097&#0000108&#0000101&#0000114&#0000116&#0000040&#0000039&#0000088&#0000083&#0000083&#0000039&#0000041>", policy).getCleanHTML().IndexOf("<img") == -1);
                Assert.IsTrue(antisamy.scan("<IMG SRC=&#x6A&#x61&#x76&#x61&#x73&#x63&#x72&#x69&#x70&#x74&#x3A&#x61&#x6C&#x65&#x72&#x74&#x28&#x27&#x58&#x53&#x53&#x27&#x29>", policy).getCleanHTML().IndexOf("<img") == -1);
        ...
        public void testHrefAttacks()
        {
            try
            {
                //All style tests have been commented out.
