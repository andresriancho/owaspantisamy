...
public class AntiSamyHTMLTest extends TestCase {

	AntiSamy as = new AntiSamy();
	private Policy policy = null;
	
	public AntiSamyHTMLTest (String s) { super(s); }
	...
	public static Test suite() {
		...
		TestSuite suite = new TestSuite(AntiSamyHTMLTest.class);
		return suite;
	...
	public void testScriptAttacks() {
		try {
			...
			assertEquals( as.scan("test<script>alert(document.cookie)</script>",policy), "test");
			...
			assertTrue ( as.scan("<BODY onload!#$%&()*~+-_.,:;?@[/|\\]^`=alert(\"XSS\")>",policy).getCleanHTML().indexOf("<body") == -1 );
			assertTrue ( as.scan("<BODY ONLOAD=alert('XSS')>",policy).getCleanHTML().indexOf("<body") == -1 );
	...
	public void testImgAttacks() {
		...
		try {
			...
			assertEquals ( as.scan("<img src='http://www.myspace.com/img.gif'>",policy),"<img src=\"http://www.myspace.com/img.gif\">" );
			assertEquals ( as.scan("<img src=javascript:alert(document.cookie)>",policy), "");
			assertTrue ( as.scan("<IMG SRC=&#106;&#97;&#118;&#97;&#115;&#99;&#114;&#105;&#112;&#116;&#58;&#97;&#108;&#101;&#114;&#116;&#40;&#39;&#88;&#83;&#83;&#39;&#41;>",policy).getCleanHTML().indexOf("<img") == -1 );
			assertTrue ( as.scan("<IMG SRC=&#0000106&#0000097&#0000118&#0000097&#0000115&#0000099&#0000114&#0000105&#0000112&#0000116&#0000058&#0000097&#0000108&#0000101&#0000114&#0000116&#0000040&#0000039&#0000088&#0000083&#0000083&#0000039&#0000041>",policy).getCleanHTML().indexOf("<img") == -1 );
			assertTrue ( as.scan("<IMG SRC=&#x6A&#x61&#x76&#x61&#x73&#x63&#x72&#x69&#x70&#x74&#x3A&#x61&#x6C&#x65&#x72&#x74&#x28&#x27&#x58&#x53&#x53&#x27&#x29>",policy).getCleanHTML().indexOf("<img") == -1 );
			assertTrue ( as.scan("<IMG SRC=\"jav&#x0D;ascript:alert('XSS');\">",policy).getCleanHTML().indexOf("<img") == -1 );
			assertTrue ( as.scan("<IMG SRC=\"javascript:alert('XSS')\"",policy).getCleanHTML().indexOf("<img") == -1 );
			assertTrue ( as.scan("<IMG LOWSRC=\"javascript:alert('XSS')\">",policy).getCleanHTML().indexOf("<img") == -1 );
			assertTrue ( as.scan("<BGSOUND SRC=\"javascript:alert('XSS');\">",policy).getCleanHTML().indexOf("src") == -1 );
